    ...
    <v-layout>
        <v-flex xs12 sm6 offset-sm3>
            ...
            <v-layout row class="login-as-a">
                ...
                <v-flex>
                    <v-btn color="primary" block block class="ma-0 py-3" href="/college/login">
                        College
                    </v-btn>
                </v-flex>
                <v-flex>
            ...
            <v-card class="pa-4">
                <v-card-title primary-title>
                    <div>
                        <h3 class="headline mb-0">LOG IN AS COLLEGE</h3>
                ...
                <form method="POST" action="{{ route('college.login.submit') }}" class="pa-3">
                    @csrf
                    <v-text-field
                        name="email"
