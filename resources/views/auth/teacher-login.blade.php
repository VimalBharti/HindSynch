    ...
    <v-layout>
        <v-flex xs12 sm6 offset-sm3>
            ...
            <v-layout row class="login-as-a">
                ...
                <v-flex>
                    <v-btn color="primary" block class="ma-0 py-3" href="/teacher/login">
                        Tutor
                    </v-btn>
                </v-flex>
                <v-flex>
            ...
            <v-card class="pa-4">
                <v-card-title primary-title>
                    <div>
                        <h3 class="headline mb-0">LOG IN AS TUTOR</h3>
                        <h4>Coach The Students and Build Your Presence</h4>
                        <div>Share your expertise and give back incredible knowledge to students looking for career guidance and positively impact their lives.</div>
                    </div>
                </v-card-title>

                <form method="POST" action="{{ route('teacher.login.submit') }}" class="pa-3">
                    @csrf
                    <v-text-field
                        name="email"
